...
if os.path.exists("memory/database.py"):
    os.remove("memory/database.py")
    print("Arquivo problemático removido!")

# Criar novo arquivo database.py
database_code = """# memory/database.py
import sqlite3
import json
import logging
...
# Salvar arquivo
with open("memory/database.py", "w", encoding="utf-8") as f:
    f.write(database_code)

print("✅ Novo arquivo database.py criado!")
